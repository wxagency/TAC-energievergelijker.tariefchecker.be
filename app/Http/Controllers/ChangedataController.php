...
class ChangedataController extends Controller
{
    public function changedata_private(Request $request){
        ...
        if($usage_elec_day!=null && $usage_elec_night!=null){
       ...
       // $query['meterType'] = 'double';
        ...
        if($usage_elec_dayde!=null && $usage_elec_nightde!=null && $consuption_excl_nightde!=null){
        ...
        if($consuption1se!=null && $consuption_excl_nightse!=null){
   ...
   if($query['IncludeG']==1){
      ...
      if($Cuntotal==0){
       ...
       // $queryGas['category']=  $getParameters['parameters']['values']['comparison_type'];
        ...
        $activeQueries['locale'] = $products[0]['parameters']['values']['locale'];   
