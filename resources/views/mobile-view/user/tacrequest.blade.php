                               ...
                               @endphp
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-sm-5">
                                        ...
                                        <div id="reg-form">
                                          <form action="{{url('data-request')}}" method="post" id="request-button">
                                                {{ csrf_field()}}
                                          ...
                                          @if(Session::get('url'))
                                           ...
                                           <input type="hidden" class="get_url" name="get_url" value="bevestiging/{{$product['supplier']['name']}}/{{$product['product']['name']}}?type=dual&eid={{$eid}}&gid={{$gid}}&u=@if(isset($_COOKIE['uuid'])){{$_COOKIE['uuid']}}@endif">
                                        ...
                                        <p id="msg" style="display:none;color:red;">@lang('home.request_page_submit_error')</p>
                                         ...
                                         <input type="hidden" id='active-price' name="active-price" value="{{$prc}}">
                                         <input type="hidden" id='active-title' name="active-title" value="{{$product['product']['name']}}">
                                         <input type="hidden" id='analytics_id' name="analytics_id" value="{{$_COOKIE['analytics_id']}}">

                                            <button class="req-btn-new ladda-button request-buttons loader" type="submit"  
                                             name="submit" value="@lang('home.Submit')" id="send">@lang('home.Submit')&nbsp; &nbsp;&nbsp; <span class="spinner-border" id="loading" style="display:none;"></span></button>
                                    ...
                                    <div class="col-md-5 col-sm-5">
                                        ...
                                        <p id="msg" style="display:none;color:red;">@lang('home.request_page_submit_error')</p>
                                         ...
                                         <input type="hidden" id='analytics_id' name="analytics_id" value="{{$_COOKIE['analytics_id']}}">
                                            ...
                                            <button class="req-btn-new ladda-button request-buttons loader" type="submit"   name="submit" value="@lang('home.Submit')" id="send">@lang('home.Submit')&nbsp; &nbsp;&nbsp; <span class="spinner-border" id="loading" style="display:none;"></span></button>
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-sm-5">
                                        ...
                                        <div id="reg-form">
                                          ...
                                          <input type="hidden" id="get_url" name="get_url" class="get_url" value="bevestiging/{{$product['supplier']['name']}}/{{$product['product']['name']}}?u=@if(isset($_COOKIE['uuid'])){{$_COOKIE['uuid']}}@endif&type={{$product['parameters']['values']['comparison_type']}}&id={{$product['product']['_id']}}">
                                          <input type="hidden" id="type" name="type" value="{{$product['parameters']['values']['comparison_type']}}">
                                           <input type="hidden" id="id" name="id" value="{{$product['product']['id']}}">
                                   ...
                                   <a href="https://atv.be/nieuws/in-de-rand-rond-antwerpen-betaalt-u-een-pak-meer-voor-uw-elektriciteit-54862" target="_blank"><img src="{{url('images/Dimitri.png')}}" alt="Dimitri"></a>
                                    ...
                                    <div class="bottom-content">
                                        ...
                                        <input type="hidden" id='active-price' value="{{$prc}}">
                                         ...
                                         <input type="hidden" id='analytics_id' value="{{$_COOKIE['analytics_id']}}">
                                    </div>
                                </div>
                            </div>
                        </div>
