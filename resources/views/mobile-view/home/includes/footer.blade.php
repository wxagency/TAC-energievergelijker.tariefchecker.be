    ...
    <div class="container">
        <div class="row">
			...
			<p>{{str_replace($replace2, $info2, $string2)}}</p>
                    ...
                    <ul>
                        <li><a href="https://www.tariefchecker.be/algemene-voorwaarden-en-bescherming-van-de-persoonsgegevens">@lang('home.Terms_conditions')</a></li>
                        <li><a href="https://www.tariefchecker.be/contact">@lang('home.Contact')</a></li>
                        <li><a href="https://www.tariefchecker.be/energie/faq">@lang('home.Frequently_asked')</a></li>
