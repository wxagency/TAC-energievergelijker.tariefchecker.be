					...
					<div class="col-md-3 col-3">
						<p class="duration-p2">
                            ...
                            @else
                                @if($duration['product']['contract_duration']=='123') @lang('home.123year')@elseif($duration['product']['contract_duration']=='13') @lang('home.13year')@elseif($duration['product']['contract_duration']=='0') @lang('home.Undetermined')@else {{$duration['product']['contract_duration']}} @lang('home.Year')@endif
                            @endif    
						    <!--@if($duration['product']['contract_duration']=='123') 1,2,3 @else {{$duration['product']['contract_duration']}} @endif @lang('home.Year')-->
						</p>
					</div>
...
@endphp
				...
				<div class="particular-sec">
					...
					<!--		<p>@lang('home.Like_all_residential') <a href="#">FAQ</a>.</p>-->
					<!--	</div>-->
					<!--</div>-->
				</div>
				...
				<div class="document-sec">
					<div class="row">
						...
						<div class="col-md-3 col-3">
						<ul>
<!--                                                        <li><a href="#"><i class="fas fa-file"></i>&nbsp @lang('home.Tariff_card_Electricity')</a></li>
                                                        <li><a href="#"><i class="fas fa-file"></i>&nbsp @lang('home.Tariff_card_Gas')</a></li>-->
...
<p class="checkp2">{{$discountss['parameters']['value']*100}} % @lang('home.on_consumption')</p>
     ...
     <!--                                                @foreach($res as $certif)-->
					<!--		<div class="col-md-3 col-3 fix-p">-->
					<!--			<p>&#8364; {{number_format($certif['price']['breakdown']['electricity']['taxes']['tax']/100,2,',', '.') }}</p>-->
					<!--		</div>-->
     <!--                                                @endforeach-->
 ...
 @if($res[0]['product']['type']=='gas'|| $res[0]['product']['type']=='pack')
     ...
     <!--                                                @foreach($res as $certif)-->
					<!--		<div class="col-md-3 col-3 fix-p">-->
					<!--			<p>&#8364; {{number_format($consump['price']['breakdown']['gas']['taxes']['tax']/100,2,',', '.') }}</p>-->
					<!--		</div>-->
     <!--                                                @endforeach-->
     ...
     <!--                                                @foreach($res as $certif)-->
					<!--		<div class="col-md-3 col-3 fix-p">-->
					<!--			<p>&#8364; {{number_format($certif['price']['breakdown']['gas']['distribution_and_transport']['transport']/100,2,',', '.') }}</p>-->
					<!--		</div>-->
     <!--                                                @endforeach-->
						...
						<div class="row">
                            ...
                            @endphp
                             ...
                             @if((Session::get('promo')=='true' && $discounts['parameters']['values']['promo_discount']['promo']=='promo') || (Session::get('domi')=='true' && $discounts['parameters']['values']['promo_discount']['discount_serviceLevelPayment']=='domi') || (Session::get('email')=='true' && $discounts['parameters']['values']['promo_discount']['discount_serviceLevelInvoicing']=='email'))
                                            ...
                                            @if($totalgas>0)
                                              {{number_format(((($discounts['price']['breakdown']['gas']['energy_cost']['fixed_fee']/100)+($discounts['price']['breakdown']['gas']['energy_cost']['usage']/100)-($promo_discG))/$totalgas)*100,2,',', '.')}}
                                            @else
                                            ...
                                            @endif
                                               &#8364;c/kWh  @endif
                                                        @else
                                                            @if(isset($discounts['price']['breakdown']['gas']['unit_cost']['energy_cost']))
                                                            @if($totalgas>0)
                                                              {{number_format(((($discounts['price']['breakdown']['gas']['energy_cost']['fixed_fee']/100)+($discounts['price']['breakdown']['gas']['energy_cost']['usage']/100))/$totalgas)*100,2,',', '.')}}
                                                            @else
                                                            0,00
                                                            @endif
                                                               &#8364;c/kWh  @endif
