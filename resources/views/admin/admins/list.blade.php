...
<!--                    <span class="kt-subheader__desc" id="kt_subheader_total">
                    ...
                    <form class="kt-margin-l-20" id="kt_subheader_search_form">
                      ...
                      <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                          <a href="{{route('admin.add-admin-users')}}" class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill" rel="tooltip" title="Create new Admin">
                              <span>
...
$(document).ready(function(){
  ...
  var datatable = $('#kt_datatable_adminuser').KTDatatable({
        ...
        columns: [
          ...
          }, 
          {
            ...
            title: 'Status',
                    ...
                    let badge = '';
                    if (status == 1) {
                        badge =`<span class="m-badge m-badge--metal m-badge--wide btn btn-success" rel="tooltip" title="Admin active in App">Active</span>`;
                        return badge;
                    } else if (status == 0) {
                        badge =`<span class="m-badge m-badge--metal m-badge--wide btn btn-danger" rel="tooltip" title="Admin is inactive">Inactive</span>`;
                        return badge;
                    }
                }
          },
       
        {
          ...
          overflow:"visible",
          template:function(t,e,a) {
              let actionEdit = "{{route('admin.admin-users.index')}}/edit/" + t.id;
              let actionDelete = "{{route('admin.admin-users.index')}}/delete/" + t.id;
