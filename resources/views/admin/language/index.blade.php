            ...
            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
              <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                  ...
                  <h5 class="kt-subheader__title">Contents in {{$language[0]['page']}}</h5>
...
$(document).ready(function(){
  var datatable = $('#kt_datatable_language').KTDatatable({
        ...
        data: {
          ...
          source: {
            read: {
              url: "{{ route('language.data', $language[0]['page_id']) }}", 
              map: function(raw) {
                // sample data mapping
                var dataSet = raw;
        ...
        columns: [
          ...
          {
            field: 'nl',
            title: 'Content in Dutch',
          },
          {
            field: 'fr',
            title: 'Content in French',
          },
          {
          field:"Actions",
          width:60,
          ...
          template:function(t,e,a) {
              let actionEdit = "{{route('language.index')}}/" + t.id + '/edit';
            return `
