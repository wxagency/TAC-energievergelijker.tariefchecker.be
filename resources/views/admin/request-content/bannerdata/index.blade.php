            ...
            <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
              ...
              <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__body kt-portlet__body--fit">
                  ...
                  <div class="kt-datatable" id="kt_datatable_banner">
...
$(document).ready(function(){
  ...
  var datatable = $('#kt_datatable_banner').KTDatatable({
        ...
        columns: [
          ...
          {
            field: 'banner_content_in_english',
          ...
          template:function(t,e,a) {
              let actionEdit = "{{route('banner-content.index')}}/" + t.id + '/edit';
              let actionDelete = "{{route('banner-content.index')}}/" + t.id;
            return `
