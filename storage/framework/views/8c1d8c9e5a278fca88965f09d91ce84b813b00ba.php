   ...
   <?php if($getParameters['parameters']['values']['includeG']==1): ?>
    ...
    <div class="button-change">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        ...
                                        <input type="hidden" value="<?php echo e($getParameters['parameters']['values']['municipality']); ?>" class="mun"> 
                                                                    ...
                                                                    <!--    <div class="checkbox-sec">-->
                                                                    <!--        <label class="container-1">-->
                                                                    <!--            <input aria-label="first_res" type="checkbox" checked="" id="first_res" name="first_res" value="true">-->
                                                                    <!--            <span class="checkmark"></span>-->
                                                                    <!--        </label>-->
                                                                    <!--        <p>First Residence</p>-->
                                                                    <!--    </div>-->
             ...
             <div class="row single" <?php if($getParameters['parameters']['values']['meter_type']=='single'): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
               <div class="col-md-12">
                    <div class="form-group consuption1r">    
                        ...
                        <input type="number" id="consuption1" <?php if($getParameters['parameters']['values']['usage_single']==0): ?> value="" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_single']); ?>" <?php endif; ?> class="consuption1 " autocomplete="off" min="0" name="consuption1" ><br>
                    </div>
                </div> 
              ...
              <div class="row single_excl_night" <?php if($getParameters['parameters']['values']['meter_type']=='single_excl_night'): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
                ...
                <div class="col-md-6">
                    <div class="form-group consuption1ser">    
                        <label> <?php echo app('translator')->getFromJson('home.Consumption'); ?> <span style="color:red;">*</span></label>
                        <input type="number" id="consuption1" <?php if($getParameters['parameters']['values']['usage_single']==0): ?> value="" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_single']); ?>" <?php endif; ?> class="consuption1se required" autocomplete="off" min="0" name="consuption1se" ><br>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group consuption_excl_nightser">    
                        ...
                        <input type="number" id="consuption_excl_night" <?php if($getParameters['parameters']['values']['usage_excl_night']==0): ?> value="" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_excl_night']); ?>" <?php endif; ?> class="consuption_excl_nightse required" autocomplete="off" min="0" name="consuption_excl_nightse" ><br>
                    </div>
                </div>    
            </div>
            ...
            <div class="row double_excl_night" <?php if($getParameters['parameters']['values']['meter_type']=='double_excl_night'): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
                 ...
                 <div class="col-md-6">
                    <div class="form-group consuption_day_elec1der">    
                        <label> <?php echo app('translator')->getFromJson('home.Consumption_Day'); ?> <span style="color:red;">*</span></label>
                        <input type="number" id="consuption_day_elec1" <?php if($getParameters['parameters']['values']['usage_day']==0): ?> value="" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_day']); ?>" <?php endif; ?> class="consuption_day_elec1de required" autocomplete="off" min="0" name="consuption_day_elec1de" ><br>
                    </div>
                </div> 
                <div class="col-md-6">
                    <div class="form-group consuption_night_elec1der">    
                        <label> <?php echo app('translator')->getFromJson('home.Consumption_Night'); ?> <span style="color:red;">*</span></label>
                        <input type="number" id="consuption_night_elec1" <?php if($getParameters['parameters']['values']['usage_night']==0): ?> value="" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_night']); ?>" <?php endif; ?> class="consuption_night_elec1de required" autocomplete="off" min="0" name="consuption_night_elec1de" ><br>
                    </div>
                </div> 
                ...
                <div class="col-md-12">
                    <div class="form-group consuption_excl_nightder">    
                        <label> <?php echo app('translator')->getFromJson('home.Consumption_excl_Night'); ?> <span style="color:red;">*</span></label>
                        <input type="number" id="consuption_excl_night" <?php if($getParameters['parameters']['values']['usage_excl_night']==0): ?> value="" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_excl_night']); ?>" <?php endif; ?> class="consuption_excl_nightde required" autocomplete="off" min="0" name="consuption_excl_nightde" ><br>
                    </div>
                </div>    
            </div> 
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="checkbox-sec">
                <label class="container-1">
                <input aria-label="dec_pro"  type="checkbox"  <?php if($getParameters['parameters']['values']['decentralise_production']==true && $getParameters['parameters']['values']['capacity_decentalise']!=""): ?> checked else  <?php endif; ?>  id="dec_pro" name="dec_pro" value="true">
                <span class="checkmark"></span>
                </label>
           ...
           <div class="col-md-12">
                <div class="field-wrapper second-field-sec">
                 ...
                 <select name="capacity_decen_pro" class="capacity_decen_pro" > 
                        ...
                        <?php if($getParameters['parameters']['values']['decentralise_production']==true): ?>
                        ...
                        <!-- <option value = "0"><?php echo app('translator')->getFromJson('home.Capacity'); ?></option> -->
        ...
        <div class="col-md-12 gas-sel" <?php if($getParameters['parameters']['values']['includeG']==1): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
            <div class="form-group consumtion_gas1r">  
                <label> <?php echo app('translator')->getFromJson('home.Consumption'); ?> <span style="color:red;">*</span></label>
                <input type="number" class="<?php if($getParameters['parameters']['values']['usage_gas']!=-1): ?> required <?php endif; ?>"  value="<?php if($getParameters['parameters']['values']['usage_gas']!=-1): ?><?php echo e($getParameters['parameters']['values']['usage_gas']); ?><?php endif; ?>" autocomplete="off" id="consumtion_gas1" name="consumtion_gas1" value=""><br>
            </div>
        </div>
        <div class="col-md-12 gas-sel" <?php if($getParameters['parameters']['values']['includeG']==1): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
                            ...
                            <input type="hidden" value="<?php echo e($getParameters['parameters']['values']['municipality']); ?>" class="mun"> 
                               ...
                               <label class="container-1">
                                ...
                                <p><?php echo app('translator')->getFromJson('home.Electricity'); ?></p>
                                                                       ...
                                                                       <div id="pro-ele" <?php if($getParameters['parameters']['values']['includeE']==0): ?> style="display: none;" <?php endif; ?> >
            ...
            <div class="row double" <?php if($getParameters['parameters']['values']['meter_type']=='double'): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
               <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group consuption_night_elec1rp">    
                        <label> <?php echo app('translator')->getFromJson('home.Consumption_Night'); ?> <span style="color:red;">*</span></label>
                        <input type="number" id="consuption_night_elec1" <?php if($getParameters['parameters']['values']['usage_night']==0): ?> value="" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_night']); ?>" <?php endif; ?> class="consuption_night_elec1p <?php if($getParameters['parameters']['values']['meter_type']=='double'): ?>  <?php else: ?> required <?php endif; ?>" autocomplete="off" min="0" name="consuption_night_elec1" ><br>
                    </div>
                </div>    
            </div>
               ...
               <div class="col-md-12">
                    <div class="form-group consuption1rp">    
                        <label> <?php echo app('translator')->getFromJson('home.Consumption'); ?> <span style="color:red;">*</span></label>
                        <input type="number" id="consuption1" <?php if($getParameters['parameters']['values']['usage_single']==0): ?> value="" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_single']); ?>" <?php endif; ?> class="consuption1p required <?php if($getParameters['parameters']['values']['meter_type']=='single'): ?> required <?php endif; ?>" autocomplete="off" min="0" name="consuption1" ><br>
                    </div>
                </div> 
              ...
              <div class="row single_excl_night" <?php if($getParameters['parameters']['values']['meter_type']=='single_excl_night'): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
                ...
                <div class="col-md-6">
                    <div class="form-group consuption1serp">    
                        <label> <?php echo app('translator')->getFromJson('home.Consumption'); ?> <span style="color:red;">*</span></label>
                        <input type="number" id="consuption1" <?php if($getParameters['parameters']['values']['usage_single']==0): ?> value="" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_single']); ?>" <?php endif; ?> class="consuption1sep required" autocomplete="off" min="0" name="consuption1se" ><br>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group consuption_excl_nightserp">    
                        <label> <?php echo app('translator')->getFromJson('home.Consumption_Night'); ?> <span style="color:red;">*</span></label>
                        <input type="number" id="consuption_excl_night" <?php if($getParameters['parameters']['values']['usage_excl_night']==0): ?> value="" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_excl_night']); ?>" <?php endif; ?> class="consuption_excl_nightsep required" autocomplete="off" min="0" name="consuption_excl_nightse" ><br>
                    </div>
                </div>    
            </div>
                ...
                <div class="row double_excl_night" <?php if($getParameters['parameters']['values']['meter_type']=='double_excl_night'): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
                 ...
                 <div class="col-md-6">
                    <div class="form-group consuption_day_elec1derp">    
                        <label> <?php echo app('translator')->getFromJson('home.Consumption_Day'); ?> <span style="color:red;">*</span></label>
                        <input type="number" id="consuption_day_elec1" <?php if($getParameters['parameters']['values']['usage_day']==0): ?> value="" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_day']); ?>" <?php endif; ?> class="consuption_day_elec1dep required" autocomplete="off" min="0" name="consuption_day_elec1de" ><br>
                    </div>
                </div> 
                <div class="col-md-6">
                    <div class="form-group consuption_night_elec1derp">    
                        <label> <?php echo app('translator')->getFromJson('home.Consumption_Night'); ?> <span style="color:red;">*</span></label>
                        <input type="number" id="consuption_night_elec1" <?php if($getParameters['parameters']['values']['usage_night']==0): ?> value="" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_night']); ?>" <?php endif; ?> class="consuption_night_elec1dep required" autocomplete="off" min="0" name="consuption_night_elec1de" ><br>
                    </div>
                </div> 
                ...
                <div class="col-md-12">
                    <div class="form-group consuption_excl_nightderp">    
                        <label> <?php echo app('translator')->getFromJson('home.Consumption_Night'); ?> <span style="color:red;">*</span></label>
                        <input type="number" id="consuption_excl_night" <?php if($getParameters['parameters']['values']['usage_excl_night']==0): ?> value="" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_excl_night']); ?>" <?php endif; ?> class="consuption_excl_nightdep required" autocomplete="off" min="0" name="consuption_excl_nightde" ><br>
                    </div>
                </div>    
            </div>
                        </div>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="checkbox-sec">
                <label class="container-1">
                <input aria-label="dec_pro" id="dec_pro1" name="dec_pro" type="checkbox"  <?php if($getParameters['parameters']['values']['decentralise_production']==true): ?> checked <?php endif; ?>  id="dec_pro" name="dec_pro" value="true">
                <span class="checkmark"></span>
                </label>
           ...
           <div class="col-md-12" id="dec_pro_data1"  <?php if($getParameters['parameters']['values']['decentralise_production']==true): ?>  <?php else: ?>  style="display:none;" <?php endif; ?>>
                <div class="form-group">
            ...
            <div class="col-md-12 gas-sel-p" id="pro-gas" <?php if($getParameters['parameters']['values']['includeG']==1): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
                <div class="form-group consumtion_gas1r">  
                    <label> <?php echo app('translator')->getFromJson('home.Consumption'); ?> <span style="color:red;">*</span></label>
                    <input type="number" class="consumtion_gas1p <?php if($getParameters['parameters']['values']['usage_gas']!=-1): ?> required <?php endif; ?>" value="<?php if($getParameters['parameters']['values']['usage_gas']!=-1): ?><?php echo e($getParameters['parameters']['values']['usage_gas']); ?><?php endif; ?>" autocomplete="off" id="consumtion_gas1" name="consumtion_gas1" ><br>
                </div>
            </div>
