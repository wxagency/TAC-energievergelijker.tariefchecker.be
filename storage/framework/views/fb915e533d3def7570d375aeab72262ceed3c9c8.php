                    ...
                    <div class="header">
                        <div class="content text-center">
                         ...
                         $param=Session::get('getParameters');
                          ...
                          ?>
                            <h3><?php echo app('translator')->getFromJson('home.Kies_hieronder'); ?><br><?php echo e(str_replace($replace, $info, $string)); ?><br>
                          <?php
                    ...
                    <div class="row sec-hide" style="margin-bottom: 15px;">
                      ...
                      <div class="col-md-4">
                       ...
                       <!--  <div class="col-md-5 col-sm-3 col-lg-6 second-sec-right text-right sec-show">
                            <div class="dropdown-sort">
                              <p><b><?php echo e(strtoupper(trans('home.SORT_BY'))); ?></b>
                                <select aria-label="Sorting" id="sort" class="sorting" name="sort">
                                  <option value=""><?php echo app('translator')->getFromJson('home.Choose'); ?></option>
                                  <option value="low"><?php echo app('translator')->getFromJson('home.High_To_Low'); ?></option>
                                  <option value="high"><?php echo app('translator')->getFromJson('home.Low_To_High'); ?></option>
                                </select>
                                </p>
...
<div id="loading" style="display:none;">
        <div class="animation-sec"  >
            ...
            <?php if($getParameters['parameters']['values']['usage_single']>0): ?>
            <div class="type">
            ...
            <?php endif; ?>
            <?php if($getParameters['parameters']['values']['usage_day']>0): ?>
            <div class="type">
                <span class="icon"><i class="fa fa-bolt"></i></span>
                <span>
            ...
            <?php endif; ?>
             <?php if($getParameters['parameters']['values']['usage_night']>0): ?>
            <div class="type">
                <span class="icon"><i class="fa fa-bolt"></i></span>
                <span>
            ...
            <?php endif; ?>
            <?php if($getParameters['parameters']['values']['usage_excl_night']>0): ?>
            <div class="type">
                <span class="icon"><i class="fa fa-bolt"></i></span>
                <span>
            ...
            <?php endif; ?>
            <?php if($getParameters['parameters']['values']['usage_gas']>0): ?>
            <div class="type">
...
<?php $wizard=DB::table('wizard')->first(); ?>

<?php if(!isset($_COOKIE['wizard'])): ?>
