					...
					<div class="col-md-3 col-3">
						<p class="duration-p2">
                            ...
                            <?php else: ?>
                                <?php if($duration['product']['contract_duration']=='123'): ?> <?php echo app('translator')->getFromJson('home.123year'); ?><?php elseif($duration['product']['contract_duration']=='13'): ?> <?php echo app('translator')->getFromJson('home.13year'); ?><?php elseif($duration['product']['contract_duration']=='0'): ?> <?php echo app('translator')->getFromJson('home.Undetermined'); ?><?php else: ?> <?php echo e($duration['product']['contract_duration']); ?> <?php echo app('translator')->getFromJson('home.Year'); ?><?php endif; ?>
                            <?php endif; ?>    
						    <!--<?php if($duration['product']['contract_duration']=='123'): ?> 1,2,3 <?php else: ?> <?php echo e($duration['product']['contract_duration']); ?> <?php endif; ?> <?php echo app('translator')->getFromJson('home.Year'); ?>-->
						</p>
					</div>
...
?>
				...
				<div class="particular-sec">
					...
					<!--	<div class="col-md-9 under-sec">-->
					<!--		<p><?php echo app('translator')->getFromJson('home.Like_all_residential'); ?> <a href="#">FAQ</a>.</p>-->
					<!--	</div>-->
					<!--</div>-->
				</div>
				...
				<div class="document-sec">
					<div class="row">
						...
						<div class="col-md-3 col-3">
						<ul>
<!--                                                        <li><a href="#"><i class="fas fa-file"></i>&nbsp <?php echo app('translator')->getFromJson('home.Tariff_card_Electricity'); ?></a></li>
                                                        <li><a href="#"><i class="fas fa-file"></i>&nbsp <?php echo app('translator')->getFromJson('home.Tariff_card_Gas'); ?></a></li>-->
...
<p class="checkp2"><?php echo e($discountss['parameters']['value']*100); ?> % <?php echo app('translator')->getFromJson('home.on_consumption'); ?></p>
     ...
     <!--                                                <?php $__currentLoopData = $res; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
					<!--		<div class="col-md-3 col-3 fix-p">-->
					<!--			<p>&#8364; <?php echo e(number_format($certif['price']['breakdown']['electricity']['taxes']['tax']/100,2,',', '.')); ?></p>-->
					<!--		</div>-->
     <!--                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>-->
 ...
 <?php if($res[0]['product']['type']=='gas'|| $res[0]['product']['type']=='pack'): ?>
     ...
     <!--                                                <?php $__currentLoopData = $res; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
					<!--		<div class="col-md-3 col-3 fix-p">-->
					<!--			<p>&#8364; <?php echo e(number_format($consump['price']['breakdown']['gas']['taxes']['tax']/100,2,',', '.')); ?></p>-->
					<!--		</div>-->
     <!--                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>-->
     ...
     <!--                                                <?php $__currentLoopData = $res; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
					<!--		<div class="col-md-3 col-3 fix-p">-->
					<!--			<p>&#8364; <?php echo e(number_format($certif['price']['breakdown']['gas']['distribution_and_transport']['transport']/100,2,',', '.')); ?></p>-->
					<!--		</div>-->
     <!--                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>-->
					...
					<div class="total-com-discount">
						<div class="row">
                            ...
                            <!--discount-->
                                        ...
                                        <?php foreach($discounts['price']['breakdown']['discounts'] as $disc){
							...
							<div class="col-md-3 col-3">
							    <?php if((Session::get('promo')=='true' && $discounts['parameters']['values']['promo_discount']['promo']=='promo') || (Session::get('domi')=='true' && $discounts['parameters']['values']['promo_discount']['discount_serviceLevelPayment']=='domi') || (Session::get('email')=='true' && $discounts['parameters']['values']['promo_discount']['discount_serviceLevelInvoicing']=='email')): ?>
							     ...
							     <?php 
                                                            ...
                                                            if($discounts['parameters']['values']['includeE']==1){
								                            ...
								                            if($discounts['parameters']['values']['includeG']==1){
                            ...
                            <!--discount end-->
                             ...
                             <?php if((Session::get('promo')=='true' && $discounts['parameters']['values']['promo_discount']['promo']=='promo') || (Session::get('domi')=='true' && $discounts['parameters']['values']['promo_discount']['discount_serviceLevelPayment']=='domi') || (Session::get('email')=='true' && $discounts['parameters']['values']['promo_discount']['discount_serviceLevelInvoicing']=='email')): ?>
                                                       <?php
                                                        ...
                                                        <?php if($totalElec>0): ?>
                                                          <?php echo e(number_format(((($discounts['price']['breakdown']['electricity']['energy_cost']['fixed_fee']/100)+($discounts['price']['breakdown']['electricity']['energy_cost']['single']/100+$discounts['price']['breakdown']['electricity']['energy_cost']['day']/100+$discounts['price']['breakdown']['electricity']['energy_cost']['night']/100+$discounts['price']['breakdown']['electricity']['energy_cost']['excl_night']/100)+($discounts['price']['breakdown']['electricity']['energy_cost']['certificates']/100)-($promo_discE))/$totalElec)*100,2,',', '.')); ?>
                                                        ...
                                                        <?php if($totalElec>0): ?>
                                                         <?php echo e(number_format(((($discounts['price']['breakdown']['electricity']['energy_cost']['fixed_fee']/100)+($discounts['price']['breakdown']['electricity']['energy_cost']['single']/100+$discounts['price']['breakdown']['electricity']['energy_cost']['day']/100+$discounts['price']['breakdown']['electricity']['energy_cost']['night']/100+$discounts['price']['breakdown']['electricity']['energy_cost']['excl_night']/100)+($discounts['price']['breakdown']['electricity']['energy_cost']['certificates']/100))/$totalElec)*100,2,',', '.')); ?>
						...
						<div class="row">
                            ...
                            ?>
                             ...
                             <?php if((Session::get('promo')=='true' && $discounts['parameters']['values']['promo_discount']['promo']=='promo') || (Session::get('domi')=='true' && $discounts['parameters']['values']['promo_discount']['discount_serviceLevelPayment']=='domi') || (Session::get('email')=='true' && $discounts['parameters']['values']['promo_discount']['discount_serviceLevelInvoicing']=='email')): ?>
                                            ...
                                            <?php if($totalgas>0): ?>
                                              <?php echo e(number_format(((($discounts['price']['breakdown']['gas']['energy_cost']['fixed_fee']/100)+($discounts['price']['breakdown']['gas']['energy_cost']['usage']/100)-($promo_discG))/$totalgas)*100,2,',', '.')); ?>
                                            ...
                                            <?php endif; ?>
                                               &#8364;c/kWh  <?php endif; ?>
                                                        <?php else: ?>
                                                            <?php if(isset($discounts['price']['breakdown']['gas']['unit_cost']['energy_cost'])): ?>
                                                            <?php if($totalgas>0): ?>
                                                              <?php echo e(number_format(((($discounts['price']['breakdown']['gas']['energy_cost']['fixed_fee']/100)+($discounts['price']['breakdown']['gas']['energy_cost']['usage']/100))/$totalgas)*100,2,',', '.')); ?>
