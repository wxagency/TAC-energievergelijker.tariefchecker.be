   ...
   <div class="container">
    <div class="main-header-sec">
      ...
      <div class="float-right-sec">
        <a href="https://www.tariefchecker.be/" <?php if(Session::get('locale')=='nl'): ?> style="color:red" <?php endif; ?> >NL</a>/ <a href="https://www.veriftarif.be/" <?php if(Session::get('locale')=='fr'): ?> style="color:red" <?php endif; ?> >FR</a>
      </div>
    </div>
  </div>
        ...
        <form action="consumption-details" class="home_page_form" method="post">
          <div class="outer_sec_form">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <!-- <label for="pwd"><?php if(Session::get('locale')=='nl'): ?> Postcode <?php else: ?> Code postal  <?php endif; ?></label> -->
                <?php if(Session::get('locale')=='nl'): ?>
