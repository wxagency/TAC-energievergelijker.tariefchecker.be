<div class="col-md-3 col-lg-3 col-sm-3 data-side">
    ...
    <div class="tab-pane fade show <?php if($getParameters['parameters']['values']['customer_group']=='residential'): ?> active <?php endif; ?>" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
        ...
        <div class="col-lg-12 col-sm-12 estim <?php if(session::get('group1')=='know_consuption'): ?> radiobtn2-show <?php else: ?>  <?php endif; ?>" style="display:none"  >
            ...
            <div class="row double" <?php if($getParameters['parameters']['values']['meter_type']=='double'): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
               <div class="col-md-6">
                    <div class="form-group consuption_day_elec1r">    
                        ...
                        <input type="number" min="0" id="consuption_day_elec1" <?php if($getParameters['parameters']['values']['usage_day']==-1): ?> value="0" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_day']); ?>" <?php endif; ?> class="consuption_day_elec1" autocomplete="off" min="0" name="consuption_day_elec1" ><br>
                    </div>
                </div> 
                <div class="col-md-6">
            ...
            <div id="dec_pro_data" class="col-md-12" <?php if($getParameters['parameters']['values']['decentralise_production']==true): ?>  <?php else: ?>  style="display:none;" <?php endif; ?>>
				            ...
				            <div class="row double" <?php if($getParameters['parameters']['values']['meter_type']=='double'): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
				               <div class="col-md-6">
				                    <div class="form-group consuption_day_elec1rp">    
				                        <label> <?php echo app('translator')->getFromJson('home.Consumption_Day'); ?> <span style="color:red;">*</span></label>
				                        <input type="number" id="consuption_day_elec1" <?php if($getParameters['parameters']['values']['usage_day']==0): ?> value="0" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_day']); ?>" <?php endif; ?> class="consuption_day_elec1p" autocomplete="off" min="0" name="consuption_day_elec1" ><br>
				                    </div>
				                </div> 
				                <div class="col-md-6">
				                    <div class="form-group consuption_night_elec1rp">    
				                        <label> <?php echo app('translator')->getFromJson('home.Consumption_Night'); ?> <span style="color:red;">*</span></label>
				                        <input type="number" id="consuption_night_elec1" <?php if($getParameters['parameters']['values']['usage_night']==0): ?> value="0" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_night']); ?>" <?php endif; ?> class="consuption_night_elec1p" autocomplete="off" min="0" name="consuption_night_elec1" ><br>
				                    </div>
				                </div>    
				            </div>
							...
							<div class="row single" <?php if($getParameters['parameters']['values']['meter_type']=='single'): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
								<div class="col-md-12">
									<div class="form-group consuption1rp">    
										<label> <?php echo app('translator')->getFromJson('home.Consumption'); ?> <span style="color:red;">*</span></label>
										<input type="number" id="consuption1" <?php if($getParameters['parameters']['values']['usage_single']==0): ?> value="0" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_single']); ?>" <?php endif; ?> class="consuption1p required <?php if($getParameters['parameters']['values']['meter_type']=='single'): ?> required <?php endif; ?>" autocomplete="off" min="0" name="consuption1" ><br>
									</div>
								</div>
							</div>
				            ...
				            <div class="row single_excl_night" <?php if($getParameters['parameters']['values']['meter_type']=='single_excl_night'): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
				                ...
				                <div class="col-md-6">
				                    <div class="form-group consuption1serp">    
				                        <label> <?php echo app('translator')->getFromJson('home.Consumption'); ?> <span style="color:red;">*</span></label>
				                        <input type="number" id="consuption1" <?php if($getParameters['parameters']['values']['usage_single']==0): ?> value="0" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_single']); ?>" <?php endif; ?> class="consuption1sep required" autocomplete="off" min="0" name="consuption1se" ><br>
				                    </div>
				                </div>
				                ...
				                <div class="col-md-6">
				                    <div class="form-group consuption_excl_nightserp">    
				                        <label> <?php echo app('translator')->getFromJson('home.Consumption_excl_Night'); ?> <span style="color:red;">*</span></label>
				                        <input type="number" id="consuption_excl_night" <?php if($getParameters['parameters']['values']['usage_excl_night']==0): ?> value="0" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_excl_night']); ?>" <?php endif; ?> class="consuption_excl_nightsep required" autocomplete="off" min="0" name="consuption_excl_nightse" ><br>
				                    </div>
				                </div> 
							...
							<div class="row double_excl_night" <?php if($getParameters['parameters']['values']['meter_type']=='double_excl_night'): ?>   <?php else: ?>  style="display:none;"  <?php endif; ?>>
								 ...
								 <div class="col-md-6">
								    <div class="form-group consuption_day_elec1derp">    
								        <label> <?php echo app('translator')->getFromJson('home.Consumption_Day'); ?> <span style="color:red;">*</span></label>
								        <input type="number" id="consuption_day_elec1" <?php if($getParameters['parameters']['values']['usage_day']==0): ?> value="0" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_day']); ?>" <?php endif; ?> class="consuption_day_elec1dep required" autocomplete="off" min="0" name="consuption_day_elec1de" ><br>
								    </div>
								</div> 
								<div class="col-md-6">
								    <div class="form-group consuption_night_elec1derp">    
								        <label> <?php echo app('translator')->getFromJson('home.Consumption_Night'); ?> <span style="color:red;">*</span></label>
								        <input type="number" id="consuption_night_elec1" <?php if($getParameters['parameters']['values']['usage_night']==0): ?> value="0" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_night']); ?>" <?php endif; ?> class="consuption_night_elec1dep required" autocomplete="off" min="0" name="consuption_night_elec1de" ><br>
								    </div>
								</div> 
								...
								<div class="col-md-12">
								    <div class="form-group consuption_excl_nightderp">    
								        <label> <?php echo app('translator')->getFromJson('home.Consumption_excl_Night'); ?> <span style="color:red;">*</span></label>
								        <input type="number" id="consuption_excl_night" <?php if($getParameters['parameters']['values']['usage_excl_night']==0): ?> value="0" <?php else: ?> value="<?php echo e($getParameters['parameters']['values']['usage_excl_night']); ?>" <?php endif; ?> class="consuption_excl_nightdep required" autocomplete="off" min="0" name="consuption_excl_nightde" ><br>
								    </div>
								</div>    
							</div>
                        </div>
