...
$endofMonth=$date->format('d/m/Y');
           ...
           <?php if($selected['packData']): ?>
            ...
            <div class="container-fluid" style="background-image: url('/images/banner_bg.jpg');">
                <div class="row">
                               ...
                               ?>
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-sm-5">
                                        ...
                                        <div id="reg-form">
                                          <form action="<?php echo e(url('data-request')); ?>" method="post" id="request-button">
                                          ...
                                          <?php if(Session::get('url')): ?>
                                           ...
                                           <input type="hidden" class="get_url" name="get_url" value="bevestiging/<?php echo e($product['supplier']['name']); ?>/<?php echo e($product['product']['name']); ?>?type=dual&eid=<?php echo e($eid); ?>&gid=<?php echo e($gid); ?>&u=<?php if(isset($_COOKIE['uuid'])): ?><?php echo e($_COOKIE['uuid']); ?><?php endif; ?>">
                                        ...
                                        <p id="msg" style="display:none;color:red;"><?php echo app('translator')->getFromJson('home.request_page_submit_error'); ?></p>
                                         ...
                                         <input type="hidden" id='active-price' name="active-price" value="<?php echo e($prc); ?>">
                                         <input type="hidden" id='active-title' name="active-title" value="<?php echo e($product['product']['name']); ?>">
                                         <input type="hidden" id='analytics_id' name="analytics_id" value="<?php echo e($_COOKIE['analytics_id']); ?>">

                                            <button class="req-btn-new ladda-button request-buttons loader" type="submit"  
                                             name="submit" value="<?php echo app('translator')->getFromJson('home.Submit'); ?>" id="send"><?php echo app('translator')->getFromJson('home.Submit'); ?>&nbsp; &nbsp;&nbsp; <span class="spinner-border" id="loading" style="display:none;"></span></button>
...
Uw aanvraag is ingediend 
                                            ...
                                            <div class="row mt-5">
                                                ...
                                                <div class="col-md-6 linktwo">
                                                 ...
                                                 <div class="col-md-12 linkcmn" style="text-align: center;">
                                                    <span class="req-btn-sec-down link-cmn"><a href="#">button</a></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-5 col-sm-5">
                                        ...
                                        <p id="msg" style="display:none;color:red;"><?php echo app('translator')->getFromJson('home.request_page_submit_error'); ?></p>
                                         ...
                                         <input type="hidden" id='analytics_id' name="analytics_id" value="<?php echo e($_COOKIE['analytics_id']); ?>">
                                            ...
                                            <button class="req-btn-new ladda-button request-buttons loader" type="submit"   name="submit" value="<?php echo app('translator')->getFromJson('home.Submit'); ?>" id="send"><?php echo app('translator')->getFromJson('home.Submit'); ?>&nbsp; &nbsp;&nbsp; <span class="spinner-border" id="loading" style="display:none;"></span></button>
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-sm-5">
                                        ...
                                        <div id="reg-form">
                                          ...
                                          <input type="hidden" id="get_url" name="get_url" class="get_url" value="bevestiging/<?php echo e($product['supplier']['name']); ?>/<?php echo e($product['product']['name']); ?>?u=<?php if(isset($_COOKIE['uuid'])): ?><?php echo e($_COOKIE['uuid']); ?><?php endif; ?>&type=<?php echo e($product['parameters']['values']['comparison_type']); ?>&id=<?php echo e($product['product']['_id']); ?>">
                                          <input type="hidden" id="type" name="type" value="<?php echo e($product['parameters']['values']['comparison_type']); ?>">
                                           <input type="hidden" id="id" name="id" value="<?php echo e($product['product']['id']); ?>">
...
Uw aanvraag is ingediend 
                                   ...
                                   <a href="https://atv.be/nieuws/in-de-rand-rond-antwerpen-betaalt-u-een-pak-meer-voor-uw-elektriciteit-54862" target="_blank"><img src="<?php echo e(url('images/Dimitri.png')); ?>" alt="Dimitri"></a>
                                    ...
                                    <div class="bottom-content">
                                        ...
                                        <input type="hidden" id='active-price' value="<?php echo e($prc); ?>">
                                         ...
                                         <input type="hidden" id='analytics_id' value="<?php echo e($_COOKIE['analytics_id']); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
   ...
   <script>
    $(document).ready(function(){
      ...
      $('.request-buttonsm').click(function(){
         ...
         if(email && firstname && lastname){
          ...
          $.ajax({
            url: '<?php echo e(url('data-request')); ?>',
                    type: 'GET',
                    data: {'uuid':uuid, 'email':email,'firstname':firstname, 'lastname':lastname, 'type':type ,'eid':eid,'gid':gid,'id':id,'active_title':active_title,'active_price':active_price,'locale':locale,'analytics_id':analytics_id},
                    beforeSend: function() {
                                  $(".loading_sec_home").show();
                                 },
                    ...
                    if(url[1] && !url[2]){
                       ...
                       $('.linkcmn').hide();
                        ...
                        // $('.link-cmn').html('<a href="'+url[1]+'" target="_blank">Klik hier</a>');
                        return false;
                        ...
                        if(!url[1] && url[2]){
                            ...
                            $('.linkone').hide();
                            $('.linkcmn').hide();
                              window.open(url[2],"_blank").focus();
                             // $('.link-cmn').html('<a href="'+url[2]+'" target="_blank">Klik hier</a>');
                             return false;
