        ...
        init: function (options) {
            var p = {
                ...
                steps:[{									//Default step settings
                    ...
                    nextText:'Volgende',						//The text in the Next Button
                    prevText:'Vorige',						//The text in the Prev Button
                ...
                lang: {										//Default language settings
                    ...
                    nextTextDefault:'Volgende',					//The text in the Next Button
                    prevTextDefault:'Vorige',					//The text in the Prev Button
                    endText:'Sluiten',						//The text in the End Tour Button
			...
			if(typeof data == 'object'){	
				...
				$.iGuiderBtnAdd = function(){
					...
					$('<div>')
						...
						.html('<span style="font-size:11px">Meer weten</span>')
						.appendTo('body');
				};
				//<div class="iguider-btn-shape"><span class="iguider-btn-icon" style="color:#fff"></span></div><div class="iguider-btnCont"></div> 
